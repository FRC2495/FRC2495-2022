...
public class Drivetrain extends Subsystem implements PIDOutput, PIDOutput2, PIDOutput3, IDrivetrain {
	...
	@Override
	public synchronized void initDefaultCommand() {
	...
	public synchronized void turnAngleUsingPidController(double angle) {
	...
	// this method needs to be paired with checkTurnAngleUsingPidController()
	public synchronized void turnToPreviousKnownHeadingUsingPidController() {
		// switches to percentage vbus
		stop(); // resets state
	...
	public synchronized boolean tripleCheckTurnAngleUsingPidController() {	
		if (isTurning) {
	...
	public synchronized void turnUsingCameraPidController()
	{
		// switches to percentage vbus
		stop(); // resets state 
	...
	public synchronized boolean tripleCheckTurnUsingCameraPidController()
	{
	...
	public synchronized void moveUsingCameraPidController()
	{
		// switches to percentage vbus
		stop(); // resets state 
	...
	public synchronized boolean tripleCheckMoveUsingCameraPidController()
	{
	...
	public synchronized void moveDistance(double dist) // moves the distance in inch given
	{
		moveDistance(dist, REDUCED_PCT_OUTPUT);
	}

	public synchronized void moveDistance(double dist, double percentOutput) // True is low gear setting, false is high gear setting
	{
	...
	public synchronized void moveDistanceHighSpeed(double dist) // moves the distance in inch given
	{
	...
	public synchronized boolean tripleCheckMoveDistance() {
		if (isMoving) {
	...
	private synchronized double arclength(int angle) // returns the inches needed to be moved
	// to turn the specified angle
	{
		return Math.toRadians(angle) * RADIUS_DRIVEVETRAIN_INCHES;
	}
	// this method needs to be paired with checkMoveDistance()
	public synchronized void moveDistanceAlongArc(int angle) {
		stop(); // in case we were still doing something
	...
	public synchronized boolean tripleCheckIfStalled() {
	...
	public synchronized void setPIDParameters()
	{
	...
	public synchronized void setNominalAndPeakOutputs(double peakOutput)
	{
	...
	public synchronized void joystickControl(Joystick joyLeft, Joystick joyRight, boolean held) // sets talons to
	// joystick control
	{
	...
	public synchronized void arcadeDrive(double movePctOutput, double turnPctOutput) {
		differentialDrive.arcadeDrive(-turnPctOutput, movePctOutput); // TODO double-check signs
	}
	
	public synchronized int getRightEncoderPosition() {
		return (int) (masterRight.getSelectedSensorPosition(PRIMARY_PID_LOOP));
	}

	public synchronized int getLeftEncoderPosition() {
	...
	public synchronized int getRightEncoderVelocity() {
		return (int) (masterRight.getSelectedSensorVelocity(PRIMARY_PID_LOOP));
	}

	public synchronized int getLeftEncoderVelocity() {
	...
	public synchronized boolean isMovingUsingCamera() {
		return isMovingUsingCamera;
	}
	
	public synchronized boolean isTurning(){
		return isTurning;
	}

	public synchronized boolean isTurningUsingCamera() {
		return isTurningUsingCamera;
	}
	...
	@Override
	public synchronized void pidWrite2(double output) {
	...
	@Override
	public synchronized void pidWrite3(double output) {
