...
public class HingeJoystickControl extends Command {
	...
	protected void initialize() {
		System.out.println("HingeJoystickControl: initialize");
	}

	// Called repeatedly when this Command is scheduled to run
	@Override
	protected void execute() {
		Robot.hingeControl.joystickControl(Robot.oi.getLeftJoystick());
	}
	...
	@Override
	protected void end() {
		System.out.println("HingeJoystickControl: end");
	...
	protected void interrupted() {
		System.out.println("HingeJoystickControl: interrupted");
