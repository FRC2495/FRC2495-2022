 ...
 *
 */
public class DrivetrainTurnUsingCameraPidControllerWithStallDetection extends Command {
	...
	protected void interrupted() {
		System.out.println("DrivetrainTurnUsingCameraPidControllerWithStallDetection: interrupted");
		end();
	}
}
